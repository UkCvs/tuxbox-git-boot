changecom(`/*', `*/')dnl
define(`bootdir',ifelse(rootfstype,`jffs2',`0:var/tuxbox/boot',`1:tuxbox/boot'))dnl
...
#define	CONFIG_BOOTCOMMAND							\
	"setenv bootargs console=$(console) root=/dev/mtdblock2 ifelse(rootfstype, `jffs2', `rw ')`rootfstype'=rootfstype;\
...
#define CONFIG_SQUASHFS_LZMA    ifelse(rootfstype,`squashfs',`1',`0')

#define	CFG_FS_PART0_TYPE	CFG_FS_`'translit(rootfstype, `a-z', `A-Z')
#define	CFG_FS_PART0_OFFSET	0x10040000
ifelse(rootfstype,`jffs2',`#define	CFG_FS_PART0_SIZE	0x7c0000',
...
#define	CONFIG_DBOX2_ENV_READ_FS		"bootdir/boot.conf"
...
#define	CONFIG_DBOX2_LCD_LOGO_FS		"bootdir/logo-lcd"
...
#define	CONFIG_DBOX2_FB_LOGO_FS			"bootdir/logo-fb"
...
#define	CONFIG_AUTOBOOT_SELECT_1_TEXT		"console on ttyCPM0 (2.6)"
#define	CONFIG_AUTOBOOT_SELECT_1_COMMAND	"setenv console ttyCPM0"
#define	CONFIG_AUTOBOOT_SELECT_2_TEXT		"console on fb0"
#define	CONFIG_AUTOBOOT_SELECT_2_COMMAND	"setenv console tty"
#define	CONFIG_AUTOBOOT_SELECT_3_TEXT		"console on ttyS0 (2.4)"
#define	CONFIG_AUTOBOOT_SELECT_3_COMMAND	"setenv console ttyS0"
